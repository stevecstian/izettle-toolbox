...
public class ItemTest {
    ...
    public void testDiscountValue() {
        ...
        Cart<TestItem, TestDiscount, TestDiscount, TestServiceCharge, ItemType> cart = 
            new Cart<TestItem, TestDiscount, TestDiscount, TestServiceCharge, ItemType>(items, null, null);
    ...
    public void testThatInverseIsCorrectWhenIncludingDiscounts() {
        List<TestItem> items;
        Cart<TestItem, TestDiscount, TestDiscount, TestServiceCharge, ItemType> cart;
        Cart<TestItem, TestDiscount, TestDiscount, TestServiceCharge, ItemType> inverse;
        ...
        cart = new Cart<TestItem, TestDiscount, TestDiscount, TestServiceCharge, ItemType>(items, null, null);
